...
$(document).ready(function () {
	...
	var activeLink = function (name) {
	    ...
	    $("#mainnav-menu").find("li[data-name='"+name+"']").parents("ul").collapse('show');

	    if (!($("#mainnav-menu").find("li[data-name='" + name + "']").children("ul")).length) {

	        $("#mainnav-menu").find("li[data-name='" + name + "']").addClass("active-link");
	    }
